...
# Invocation: brainome TRAIN_TEST_SPLITS/mc1-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/mc1.py -json btc-runs/SVM/mc1.json
# Total compiler execution time: 0:00:06.53. Finished on: Feb-26-2022 19:10:19.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/mc1.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        99.28%
      Training accuracy:          97.17% (4506/4637 correct)
      Validation Accuracy:        96.98% (1929/1989 correct)
      Combined Model Accuracy:    97.11% (6435/6626 correct)


    Model Capacity (MEC):         39    bits
    Generalization Ratio:          7.05 bits/bit
    Percent of Data Memorized:    61.07%
    Resilience to Noise:          -2.06 dB
    ...
    Training Accuracy by Class:
                   ...
                   - | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  4500    27     6   104   97.74%   18.18%   99.40%    5.45%   98.57%   97.17%
                   1 |     6   104  4500    27   18.18%   97.74%    5.45%   99.40%    8.39%    4.38%

    Validation Accuracy by Class:
                   c |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
                   - | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1926    12     3    48   97.57%   20.00%   99.38%    5.88%   98.47%   96.98%
                   1 |     3    48  1926    12   20.00%   97.57%    5.88%   99.38%    9.09%    4.76%
...
n_classes = 2
model_cap = 39
w = np.array([[0.011494574311567517, -0.04906040644329058, 0.07167758727075112, -0.026356506648675653, 0.06174071931788661, 0.016952787263707973, -0.05948298173887112, -0.06919132652955313, 0.003647510377850644, -0.05556044554218342, -0.06580708904729181, 0.005923228315792113, -0.05516777405141442, -5.065853613929809e-05, 0.021667829363051627, -0.01672526694803299, 0.05549924087537904, 0.037702598794576325, -0.0034631175676168038, 0.030593998541549688, -0.0002478947042536706, -0.0006377058710462872, -0.09717990820642183, 0.008776466862733933, -0.0001764447724099937, 0.03218775156297196, -0.06054708977756724, 0.0066526384429285825, 0.008476393631853986, -0.07451435821935243, -0.05732848394110007, -0.05941742789012139, -0.037762480316296525, -0.002401784977314194, 0.0029350038716917733, -0.057762800090802785, 0.024094136010961394, -0.004688677285623322]])
b = np.array([-0.06991243612456345])

...
# Invocation: brainome TRAIN_TEST_SPLITS/cmc-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/cmc.py -json btc-runs/SVM/cmc.json
# Total compiler execution time: 0:00:05.96. Finished on: Feb-26-2022 19:08:40.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/cmc.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        57.32%
      Training accuracy:          66.29% (478/721 correct)
      Validation Accuracy:        67.74% (210/310 correct)
      Combined Model Accuracy:    66.73% (688/1031 correct)


    Model Capacity (MEC):         10    bits
    Generalization Ratio:         47.07 bits/bit
    Percent of Data Memorized:     4.28%
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   298   128   180   115   72.15%   58.44%   69.95%   61.02%   71.04%   55.08%
                   0 |   180   115   298   128   58.44%   72.15%   61.02%   69.95%   59.70%   42.55%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   132    54    78    46   74.16%   59.09%   70.97%   62.90%   72.53%   56.90%
                   0 |    78    46   132    54   59.09%   74.16%   62.90%   70.97%   60.94%   43.82%
...
n_classes = 2
model_cap = 10
w = np.array([[0.02688143651223096, -0.12065784819598283, -0.021179664652343555, -0.11233737746480565, 0.041196148142520955, 0.0004965576727087428, 0.020166080375742232, -0.06280687858212892, 0.03447030297860028]])
b = np.array([0.008842155372573674])

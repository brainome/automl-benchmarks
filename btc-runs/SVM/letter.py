...
# Invocation: brainome TRAIN_TEST_SPLITS/letter-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/letter.py -json btc-runs/SVM/letter.json
# Total compiler execution time: 0:00:06.63. Finished on: Feb-26-2022 19:10:11.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/letter.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        95.94%
      Training accuracy:          89.00% (8722/9799 correct)
      Validation Accuracy:        88.62% (3723/4201 correct)
      Combined Model Accuracy:    88.89% (12445/14000 correct)


    Model Capacity (MEC):         17    bits
    Generalization Ratio:        125.75 bits/bit
    Percent of Data Memorized:     2.50%
    Resilience to Noise:          -2.71 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   0 |   8343     19    379   1058   88.75%   95.23%   99.77%   26.37%   93.94%   88.57%
                   1 |    379   1058   8343     19   95.23%   88.75%   26.37%   99.77%   41.31%   26.03%

    Validation Accuracy by Class:
         binaryClass |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   0 |   3559      7    164    471   88.31%   95.91%   99.80%   25.83%   93.71%   88.16%
                   1 |    164    471   3559      7   95.91%   88.31%   25.83%   99.80%   40.69%   25.55%
...
n_classes = 2
model_cap = 17
w = np.array([[0.09068304531096168, 0.08105089343640598, -0.19157371512907967, -0.24051915358094714, 0.27299980928860457, 0.00381965830304867, -0.1533421276052865, 0.08353998972361025, 0.2588520694035612, -0.1124353439881709, 0.24255242359749743, 0.10635177601427027, 0.10994373916505155, -0.04217098069755041, -0.24539170430780238, -0.24317917233522457]])
b = np.array([-0.0020328007867522176])

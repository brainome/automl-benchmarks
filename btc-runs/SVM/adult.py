...
# Invocation: brainome TRAIN_TEST_SPLITS/phpMawTba-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/adult.py -json btc-runs/SVM/adult.json
# Total compiler execution time: 0:00:07.87. Finished on: Feb-26-2022 19:12:17.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/adult.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        76.07%
      Training accuracy:          75.99% (18186/23931 correct)
      Validation Accuracy:        76.04% (7801/10258 correct)
      Combined Model Accuracy:    76.00% (25987/34189 correct)


    Model Capacity (MEC):         15    bits
    Generalization Ratio:        962.43 bits/bit
    Percent of Data Memorized:     0.23%
    Resilience to Noise:          -3.08 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |      6     25  18180   5720    0.10%   99.86%   19.35%   76.07%    0.21%    0.10%
                   0 |  18180   5720      6     25   99.86%    0.10%   76.07%   19.35%   86.36%   75.99%

    Validation Accuracy by Class:
               class |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |      2      4   7799   2453    0.08%   99.95%   33.33%   76.07%    0.16%    0.08%
                   0 |   7799   2453      2      4   99.95%    0.08%   76.07%   33.33%   86.39%   76.04%
...
n_classes = 2
model_cap = 15
w = np.array([[-1.5220870794355666e-13, -3.362036897008767e-12, 8.865595057593247e-10, -2.3187719963335022e-10, -1.6805106919141232e-13, -1.2117079419553186e-10, 8.27089473034711e-11, 2.6853423636854163e-10, -2.3083778415629723e-11, 1.337689728083006e-10, -4.898632545420134e-10, -1.7956951850770246e-11, -4.358787070691633e-13, 3.248869214116872e-10]])
b = np.array([7.318555335930387e-15])

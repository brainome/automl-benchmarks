...
# Invocation: brainome TRAIN_TEST_SPLITS/GAMETES_Epistasis_2-Way_20atts_0.4H_EDM-1_1-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/GAMETES_Epistasis_2_Way_20atts_0.4H_EDM_1_1_RF.py -json btc-runs/SVM/GAMETES_Epistasis_2_Way_20atts_0.4H_EDM_1_1_RF.json
# Total compiler execution time: 0:00:05.99. Finished on: Feb-26-2022 19:09:10.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/GAMETES_Epistasis_2_Way_20atts_0.4H_EDM_1_1_RF.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        50.00%
      Training accuracy:          53.31% (418/784 correct)
      Validation Accuracy:        48.21% (162/336 correct)
      Combined Model Accuracy:    51.78% (580/1120 correct)


    Model Capacity (MEC):         21    bits
    Generalization Ratio:         19.90 bits/bit
    Percent of Data Memorized:    10.05%
    ...
    Training Accuracy by Class:
               ...
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   229   203   189   163   58.42%   48.21%   53.01%   53.69%   55.58%   38.49%
                   0 |   189   163   229   203   48.21%   58.42%   53.69%   53.01%   50.81%   34.05%

    Validation Accuracy by Class:
               class |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |    86    92    76    82   51.19%   45.24%   48.31%   48.10%   49.71%   33.08%
                   0 |    76    82    86    92   45.24%   51.19%   48.10%   48.31%   46.63%   30.40%
...
n_classes = 2
model_cap = 21
w = np.array([[-0.017136831433733846, 0.008328819408068934, 0.021111044004414325, 0.011014057609876261, -0.01197703241481542, -0.013764176674539368, 0.01016530407600225, -0.010931994358904625, 0.002363614156795436, -0.0339222980145874, 0.013655896967410852, -0.008083220238542459, -0.011797929604956198, 0.01153519132865377, -0.005396997458512536, 0.019790330594313076, -0.010065765111714548, -0.002859660506621405, 0.012237213669439459, 0.008769795428651417]])
b = np.array([0.008671859891566564])

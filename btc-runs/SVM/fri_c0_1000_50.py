...
# Invocation: brainome TRAIN_TEST_SPLITS/fri_c0_1000_50-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/fri_c0_1000_50.py -json btc-runs/SVM/fri_c0_1000_50.json
# Total compiler execution time: 0:00:06.06. Finished on: Feb-26-2022 19:09:02.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/fri_c0_1000_50.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        51.00%
      Training accuracy:          86.50% (423/489 correct)
      Validation Accuracy:        81.04% (171/211 correct)
      Combined Model Accuracy:    84.85% (594/700 correct)


    Model Capacity (MEC):         51    bits
    Generalization Ratio:          8.29 bits/bit
    Percent of Data Memorized:    24.13%
    ...
    Training Accuracy by Class:
         ...
         ----------- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   1 |  212   38  211   28   88.33%   84.74%   84.80%   88.28%   86.53%   76.26%
                   0 |  211   28  212   38   84.74%   88.33%   88.28%   84.80%   86.48%   76.17%

    Validation Accuracy by Class:
         binaryClass |   TP   FP   TN   FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   1 |   85   22   86   18   82.52%   79.63%   79.44%   82.69%   80.95%   68.00%
                   0 |   86   18   85   22   79.63%   82.52%   82.69%   79.44%   81.13%   68.25%
...
n_classes = 2
model_cap = 51
w = np.array([[-0.14754181018849258, -0.17781187532017043, -0.001460151186744333, -0.2117882538006462, -0.10685246794779474, 0.027262778644269934, 0.008558184119277694, -0.0038529086712266523, -0.02130641454277504, 0.00762639957699346, -0.00040761193000908434, -0.00667268983802783, -0.025762950797385425, -0.02172773002876602, 0.02222636852256601, 0.00537258000141922, 0.008083313923778751, -0.02594562032374584, 0.004945473063571345, 0.01554863176756497, 0.0049695786140315275, 0.018801344977891075, 0.025170463237141186, -0.038373782135303895, 0.006741065777898347, 0.0011641727488818873, -0.013987600817869754, 0.00445279036099858, 0.01016439635193665, -0.038972287218774056, -0.005207119997236897, -0.00671208219578437, 0.0011340660894386214, 0.005146165390647498, 0.0033065714134349116, -0.03832837390769175, -0.005568931415622719, 0.019668760752002593, -0.03631258674523235, -0.027321311508284568, -0.0015763678548769767, -0.011758349309349098, 0.008082534158111205, -0.014428508348658536, -0.0239693387876807, 0.03246768277362397, -0.0005762600322404724, -0.0030210303581454812, -0.042157431164657325, -0.013231672927800262]])
b = np.array([-0.0007224654389046505])

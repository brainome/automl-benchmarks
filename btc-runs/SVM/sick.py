...
# Invocation: brainome TRAIN_TEST_SPLITS/dataset_38_sick-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/sick.py -json btc-runs/SVM/sick.json
# Total compiler execution time: 0:00:06.20. Finished on: Feb-26-2022 19:12:25.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/sick.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        93.86%
      Training accuracy:          93.99% (1736/1847 correct)
      Validation Accuracy:        93.82% (744/793 correct)
      Combined Model Accuracy:    93.93% (2480/2640 correct)


    Model Capacity (MEC):         30    bits
    Generalization Ratio:         19.22 bits/bit
    Percent of Data Memorized:    15.04%
    Resilience to Noise:          -1.76 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1734   111     2     0  100.00%    1.77%   93.98%  100.00%   96.90%   93.98%
                   1 |     2     0  1734   111    1.77%  100.00%  100.00%   93.98%    3.48%    1.77%

    Validation Accuracy by Class:
               Class |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   744    49     0     0  100.00%    0.00%   93.82%      N/A   96.81%   93.82%
                   1 |     0     0   744    49    0.00%  100.00%      N/A   93.82%    0.00%    0.00%
...
n_classes = 2
model_cap = 30
w = np.array([[2.4747617654997216e-14, 8.907206750763174e-11, -3.461702699551222e-10, 3.0638949320635106e-10, -5.726561953119079e-10, 1.0441883459734088e-09, -1.4711925856644922e-09, -9.817951302499222e-10, -5.003985192330994e-10, 7.447779419531928e-10, -1.0779915723938248e-10, -1.1002336062913746e-09, 1.117872427577172e-09, -1.0068207264797157e-10, 2.9660653561227885e-09, -7.371858397388483e-10, -4.34641554355593e-11, -1.7603244161849322e-10, -4.9329470771689954e-11, -1.3567509010362938e-10, -5.721552300164315e-11, -8.143028302656564e-11, -5.701678223714103e-11, -8.277890994241536e-11, -8.852088090507551e-11, 1.3400861642156987e-10, -6.149614785917803e-11, -5.195729191923897e-11, -2.0984979931678223e-10]])
b = np.array([-3.084754467536826e-20])

...
# Invocation: brainome TRAIN_TEST_SPLITS/php50jXam-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/banknote_authentication.py -json btc-runs/SVM/banknote_authentication.json
# Total compiler execution time: 0:00:05.93. Finished on: Feb-26-2022 19:08:32.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/banknote_authentication.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        55.52%
      Training accuracy:          97.01% (651/671 correct)
      Validation Accuracy:        98.61% (285/289 correct)
      Combined Model Accuracy:    97.50% (936/960 correct)


    Model Capacity (MEC):          5    bits
    Generalization Ratio:        129.02 bits/bit
    Percent of Data Memorized:     1.56%
    Resilience to Noise:          -2.11 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   1 |  286    8  365   12   95.97%   97.86%   97.28%   96.82%   96.62%   93.46%
                   0 |  365   12  286    8   97.86%   95.97%   96.82%   97.28%   97.33%   94.81%

    Validation Accuracy by Class:
               Class |   TP   FP   TN   FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   1 |  129    4  156    0  100.00%   97.50%   96.99%  100.00%   98.47%   96.99%
                   0 |  156    0  129    4   97.50%  100.00%  100.00%   96.99%   98.73%   97.50%
...
n_classes = 2
model_cap = 5
w = np.array([[0.2590470418022495, 0.13789844582150187, 0.13876347576672696, 0.05913982064370611]])
b = np.array([-0.18863122216153502])

...
# Invocation: brainome TRAIN_TEST_SPLITS/SEA_50000-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/SEA_50000.py -json btc-runs/SVM/SEA_50000.json
# Total compiler execution time: 0:00:24.47. Finished on: Feb-26-2022 19:09:59.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/SEA_50000.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        61.43%
      Training accuracy:          82.84% (405934/489999 correct)
      Validation Accuracy:        82.90% (174100/210001 correct)
      Combined Model Accuracy:    82.86% (580034/700000 correct)


    Model Capacity (MEC):          4    bits
    Generalization Ratio:      97621.76 bits/bit
    Percent of Data Memorized:     0.00%
    Resilience to Noise:          -5.01 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ------- ------- ------- ------- -------- -------- -------- -------- -------- --------
                   1 |  160097   55185  245837   28880   84.72%   81.67%   74.37%   89.49%   79.21%   65.57%
                   0 |  245837   28880  160097   55185   81.67%   84.72%   89.49%   74.37%   85.40%   74.52%

    Validation Accuracy by Class:
               class |      TP      FP      TN      FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ------- ------- ------- ------- -------- -------- -------- -------- -------- --------
                   1 |   68717   23627  105383   12274   84.85%   81.69%   74.41%   89.57%   79.29%   65.68%
                   0 |  105383   12274   68717   23627   81.69%   84.85%   89.57%   74.41%   85.45%   74.59%
...
n_classes = 2
model_cap = 4
w = np.array([[0.1625873167478133, 0.16258767589313342, -0.0011412143662352004]])
b = np.array([-1.5164269913610278])

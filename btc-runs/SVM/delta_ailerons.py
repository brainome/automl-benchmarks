...
# Invocation: brainome TRAIN_TEST_SPLITS/delta_ailerons-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/delta_ailerons.py -json btc-runs/SVM/delta_ailerons.json
# Total compiler execution time: 0:00:06.11. Finished on: Feb-26-2022 19:08:47.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/delta_ailerons.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        53.07%
      Training accuracy:          91.23% (3186/3492 correct)
      Validation Accuracy:        90.85% (1361/1498 correct)
      Combined Model Accuracy:    91.12% (4547/4990 correct)


    Model Capacity (MEC):          6    bits
    Generalization Ratio:        529.56 bits/bit
    Percent of Data Memorized:     0.38%
    Resilience to Noise:          -2.73 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1695   148  1491   158   91.47%   90.97%   91.97%   90.42%   91.72%   84.71%
                   1 |  1491   158  1695   148   90.97%   91.47%   90.42%   91.97%   90.69%   82.97%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   720    62   641    75   90.57%   91.18%   92.07%   89.53%   91.31%   84.01%
                   1 |   641    75   720    62   91.18%   90.57%   89.53%   92.07%   90.35%   82.39%
...
n_classes = 2
model_cap = 6
w = np.array([[-0.035814114987423706, -0.00021618589277232992, 0.007367112131205028, -0.00663598044391942, -0.0006031437794595663]])
b = np.array([-4.702598932345217e-05])

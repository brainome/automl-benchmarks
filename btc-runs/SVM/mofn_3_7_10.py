...
# Invocation: brainome TRAIN_TEST_SPLITS/mofn-3-7-10-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/mofn_3_7_10.py -json btc-runs/SVM/mofn_3_7_10.json
# Total compiler execution time: 0:00:05.96. Finished on: Feb-26-2022 19:11:17.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/mofn_3_7_10.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        77.97%
      Training accuracy:          91.96% (595/647 correct)
      Validation Accuracy:        89.60% (250/279 correct)
      Combined Model Accuracy:    91.25% (845/926 correct)


    Model Capacity (MEC):         11    bits
    Generalization Ratio:         41.07 bits/bit
    Percent of Data Memorized:     5.39%
    Resilience to Noise:          -1.73 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   0 |  503   50   92    2   99.60%   64.79%   90.96%   97.87%   95.09%   90.63%
                   1 |   92    2  503   50   64.79%   99.60%   97.87%   90.96%   77.97%   63.89%

    Validation Accuracy by Class:
               class |   TP   FP   TN   FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   0 |  217   29   33    0  100.00%   53.23%   88.21%  100.00%   93.74%   88.21%
                   1 |   33    0  217   29   53.23%  100.00%  100.00%   88.21%   69.47%   53.23%
...
n_classes = 2
model_cap = 11
w = np.array([[0.057233387832101135, 0.0480353145749435, -0.10679294912156505, -0.13200959776423224, -0.13933298904576724, -0.09327979089996256, -0.11114246876398076, -0.10053294114640962, -0.14093709482548325, 0.07018134441647923]])
b = np.array([0.136703376260055])

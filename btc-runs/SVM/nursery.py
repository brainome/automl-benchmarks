...
# Invocation: brainome TRAIN_TEST_SPLITS/nursery-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/nursery.py -json btc-runs/SVM/nursery.json
# Total compiler execution time: 0:00:06.39. Finished on: Feb-26-2022 19:12:08.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/nursery.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        66.67%
      Training accuracy:          88.51% (5620/6349 correct)
      Validation Accuracy:        87.69% (2388/2723 correct)
      Combined Model Accuracy:    88.27% (8008/9072 correct)


    Model Capacity (MEC):          9    bits
    Generalization Ratio:        573.39 bits/bit
    Percent of Data Memorized:     0.36%
    Resilience to Noise:          -2.80 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |  1515   128  4105   601   71.60%   96.98%   92.21%   87.23%   80.61%   67.51%
                   0 |  4105   601  1515   128   96.98%   71.60%   87.23%   92.21%   91.84%   84.92%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   634    61  1754   274   69.82%   96.64%   91.22%   86.49%   79.10%   65.43%
                   0 |  1754   274   634    61   96.64%   69.82%   86.49%   91.22%   91.28%   83.96%
...
n_classes = 2
model_cap = 9
w = np.array([[3.982962688444902e-10, 3.385822472932972e-10, 1.1310036464389073e-10, -1.9657377144212182e-12, 1.3710825422834946e-10, 2.2818300336093666e-08, 3.8600303813268475e-10, -3.467213451544153e-08]])
b = np.array([5.868569153662736e-15])

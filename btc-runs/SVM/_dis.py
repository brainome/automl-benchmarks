...
# Invocation: brainome TRAIN_TEST_SPLITS/dis-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/_dis.py -json btc-runs/SVM/_dis.json
# Total compiler execution time: 0:00:06.12. Finished on: Feb-26-2022 19:08:55.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/_dis.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        98.45%
      Training accuracy:          88.52% (1635/1847 correct)
      Validation Accuracy:        90.16% (715/793 correct)
      Combined Model Accuracy:    89.01% (2350/2640 correct)


    Model Capacity (MEC):         30    bits
    Generalization Ratio:          6.18 bits/bit
    Percent of Data Memorized:    61.18%
    ...
    Training Accuracy by Class:
               ...
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1628    21     7   191   89.50%   25.00%   98.73%    3.54%   93.89%   88.48%
                   1 |     7   191  1628    21   25.00%   89.50%    3.54%   98.73%    6.19%    3.20%

    Validation Accuracy by Class:
               class |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   707     5     8    73   90.64%   61.54%   99.30%    9.88%   94.77%   90.06%
                   1 |     8    73   707     5   61.54%   90.64%    9.88%   99.30%   17.02%    9.30%
...
n_classes = 2
model_cap = 30
w = np.array([[0.005429193357525528, -0.0020862234073421105, -0.11254143042873872, -0.013296751283401043, -0.011946874626226817, -0.036005617012211916, -0.011595739131699615, -0.013822360289108774, -0.015339021452967921, 0.04390803080561076, -0.017991505820011935, -0.0032961379199633076, -0.007153139416650591, -0.028325290553527747, -0.0004886122578156743, 0.040285310358980836, 0.0599746354719278, -0.0030432301367150734, 0.05871039996201527, -0.00037196726527581337, 0.05919798662385864, -0.002500513018251826, 0.05010003056387821, -0.0066545707868393604, 0.0501000305638782, 0.000913834687427003, 0.0, 0.0, -0.017261440260691444]])
b = np.array([0.059197986623858626])

...
# Invocation: brainome TRAIN_TEST_SPLITS/GAMETES_Epistasis_3-Way_20atts_0.2H_EDM-1_1-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/GAMETES_Epistasis_3_Way_20atts_0.2H_EDM_1_1_NN.py -json btc-runs/SVM/GAMETES_Epistasis_3_Way_20atts_0.2H_EDM_1_1_NN.json
# Total compiler execution time: 0:00:05.99. Finished on: Feb-26-2022 19:09:17.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/GAMETES_Epistasis_3_Way_20atts_0.2H_EDM_1_1_NN.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        50.00%
      Training accuracy:          54.46% (427/784 correct)
      Validation Accuracy:        49.40% (166/336 correct)
      Combined Model Accuracy:    52.94% (593/1120 correct)


    Model Capacity (MEC):         21    bits
    Generalization Ratio:         20.33 bits/bit
    Percent of Data Memorized:     9.84%
    ...
    Training Accuracy by Class:
               ...
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   210   175   217   182   53.57%   55.36%   54.55%   54.39%   54.05%   37.04%
                   0 |   217   182   210   175   55.36%   53.57%   54.39%   54.55%   54.87%   37.80%

    Validation Accuracy by Class:
               class |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |    80    82    86    88   47.62%   51.19%   49.38%   49.43%   48.48%   32.00%
                   0 |    86    88    80    82   51.19%   47.62%   49.43%   49.38%   50.29%   33.59%
...
n_classes = 2
model_cap = 21
w = np.array([[-0.04786660591602426, 0.003540716114935496, 0.01450391683980715, -0.016261278222401955, 0.022255348096122257, -0.02737900153290126, 0.01116295005624325, -0.0027729096440572186, 0.03190725510256897, -0.013034125066576334, 0.006894852273166562, -0.005354785605905135, 0.009290020030368893, 0.011773212562819426, 0.003962479206399469, 0.0003972627293441322, 0.015287016577297077, -0.004128324864315641, 0.015140529001819326, 0.035242813508745786]])
b = np.array([-0.0044587695491832054])

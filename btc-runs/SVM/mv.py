...
# Invocation: brainome TRAIN_TEST_SPLITS/mv-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/mv.py -json btc-runs/SVM/mv.json
# Total compiler execution time: 0:00:07.29. Finished on: Feb-26-2022 19:11:35.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/mv.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        59.66%
      Training accuracy:          59.65% (11916/19975 correct)
      Validation Accuracy:        59.65% (5108/8562 correct)
      Combined Model Accuracy:    59.65% (17024/28537 correct)


    Model Capacity (MEC):         11    bits
    Generalization Ratio:       1053.95 bits/bit
    Percent of Data Memorized:     0.19%
    Resilience to Noise:          -3.03 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |  11916   8059      0      0  100.00%    0.00%   59.65%      N/A   74.73%   59.65%
                   0 |      0      0  11916   8059    0.00%  100.00%      N/A   59.65%    0.00%    0.00%

    Validation Accuracy by Class:
         binaryClass |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |   5108   3454      0      0  100.00%    0.00%   59.66%      N/A   74.73%   59.66%
                   0 |      0      0   5108   3454    0.00%  100.00%      N/A   59.66%    0.00%    0.00%
...
n_classes = 2
model_cap = 11
w = np.array([[-1.0726549203405e-12, -1.2455575704689287e-13, -5.355029578602986e-10, -2.835191067960559e-12, 3.3965371053235887e-15, -1.417279934695574e-11, 2.9543669854467476e-10, -1.0743741258209757e-09, 2.49036959459145e-12, 5.494233762274707e-12]])
b = np.array([3.687473137439775e-15])

...
# Invocation: brainome TRAIN_TEST_SPLITS/MiniBooNE-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/MiniBooNE.py -json btc-runs/SVM/MiniBooNE.json
# Total compiler execution time: 0:00:42.75. Finished on: Feb-26-2022 19:11:04.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/MiniBooNE.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        71.94%
      Training accuracy:          74.28% (47340/63730 correct)
      Validation Accuracy:        73.94% (20197/27314 correct)
      Combined Model Accuracy:    74.18% (67537/91044 correct)


    Model Capacity (MEC):         51    bits
    Generalization Ratio:        794.84 bits/bit
    Percent of Data Memorized:     0.27%
    Resilience to Noise:          -2.97 dB
    ...
    Training Accuracy by Class:
              signal |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
              ------ | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |  29806    350  17534  16040   65.01%   98.04%   98.84%   52.22%   78.43%   64.52%
                   0 |  17534  16040  29806    350   98.04%   65.01%   52.22%   98.84%   68.15%   51.69%

    Validation Accuracy by Class:
              signal |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
              ------ | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |  12680    148   7517   6969   64.53%   98.07%   98.85%   51.89%   78.09%   64.05%
                   0 |   7517   6969  12680    148   98.07%   64.53%   51.89%   98.85%   67.87%   51.37%
...
TRAINFILE = ['TRAIN_TEST_SPLITS/MiniBooNE-clean-train.csv']
mapping = {'1': 0, '0': 1}
ignorelabels = []
ignorecolumns = []
target = ''
...
n_classes = 2
model_cap = 51
w = np.array([[-0.3110681732444468, 0.1072034977468431, -0.00034542581685087026, -0.18176654997989483, -0.045503616944874765, 0.23142694975709643, 0.320091577540055, -0.0050307185416812675, -0.05315020816992226, 0.06706204008637302, 0.12143315560760974, -0.0010029681628439104, -0.6141065312394953, -0.09420541992765387, -0.10447605061663777, 0.001750198562948042, -0.11113959621442414, -0.001053583736761715, -0.06716951462762792, 0.10394712582576841, 0.10438165221674268, -0.019900133885521993, 0.004463864598677375, -0.019551974404713734, 0.06845466794685039, -0.017575442199510984, -0.0022859740983176835, -0.06928957364791749, -0.07682479202624384, 0.18879181337126008, -0.021700493414605705, 0.5707038777894404, -0.06669426335918126, -0.0012293397394769084, -0.031074213997393334, 0.06922517166417014, 0.17190004296454237, -0.03877118095229235, -0.06386044425028216, -0.026766882510335214, 0.0022440942496589835, -0.003000353033360871, -0.012204722930701191, -0.00399084269430619, -0.05573515160964415, -0.010940397404960632, 0.08402095038179683, 0.010205840912462042, -0.0015649297131178138, -0.09196554453851775]])
b = np.array([0.07485383190870229])

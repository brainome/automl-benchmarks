...
# Invocation: brainome TRAIN_TEST_SPLITS/hypothyroid-clean-train.csv -f SVM -y -split 70 -modelonly -q -o btc-runs/SVM/hypothyroid.py -json btc-runs/SVM/hypothyroid.json
# Total compiler execution time: 0:00:06.21. Finished on: Feb-26-2022 19:09:24.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/SVM/hypothyroid.py
    Classifier Type:              Support Vector Machine (Linear Kernel)
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        92.27%
      Training accuracy:          92.31% (1705/1847 correct)
      Validation Accuracy:        92.18% (731/793 correct)
      Combined Model Accuracy:    92.27% (2436/2640 correct)


    Model Capacity (MEC):         30    bits
    Generalization Ratio:         22.23 bits/bit
    Percent of Data Memorized:    12.38%
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1705   142     0     0  100.00%    0.00%   92.31%      N/A   96.00%   92.31%
                   1 |     0     0  1705   142    0.00%  100.00%      N/A   92.31%    0.00%    0.00%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   731    62     0     0  100.00%    0.00%   92.18%      N/A   95.93%   92.18%
                   1 |     0     0   731    62    0.00%  100.00%      N/A   92.18%    0.00%    0.00%
...
n_classes = 2
model_cap = 30
w = np.array([[-2.0126085855058747e-10, -1.642205923665681e-11, -7.336798388886146e-10, -4.695510423800496e-11, -9.440502926028976e-10, -2.047947785924318e-10, -8.098103678271354e-10, -1.0918125409193432e-11, 4.697144169516141e-10, 5.924433642222792e-10, -5.828504059012474e-12, 2.91988600373247e-10, -8.706252678843329e-10, -7.255871837579221e-11, -5.996028722686405e-11, -3.100553010331924e-10, 3.200186091768504e-10, -1.2480386597494456e-10, 2.9805297114499417e-10, 2.6247962177386875e-11, 2.9372369338052487e-10, 5.593984543538741e-11, 2.9812123330497284e-10, 2.577961446687199e-11, 2.9812123330497284e-10, 2.5685689491871025e-11, 2.688550490406333e-10, 2.2715211851894148e-10, 4.010911869385769e-11]])
b = np.array([1.3486240073883693e-19])

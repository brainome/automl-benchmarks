...
# Invocation: brainome TRAIN_TEST_SPLITS/phpznF975-clean-train.csv -f RF -y -split 70 -modelonly -q -o btc-runs/RF/Speech.py -json btc-runs/RF/Speech.json
# Total compiler execution time: 0:00:08.57. Finished on: Feb-26-2022 18:36:51.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/RF/Speech.py
    Classifier Type:              Random Forest
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        98.33%
      Training accuracy:          98.39% (1776/1805 correct)
      Validation Accuracy:        98.06% (760/775 correct)
      Combined Model Accuracy:    98.29% (2536/2580 correct)


    Model Capacity (MEC):         13    bits
    Generalization Ratio:         16.67 bits/bit
    Percent of Data Memorized:    22.38%
    ...
    Training Accuracy by Class:
              ...
              ------ | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |  1774    28     2     1   99.94%    6.67%   98.45%   66.67%   99.19%   98.39%
                   0 |     2     1  1774    28    6.67%   99.94%   66.67%   98.45%   12.12%    6.45%

    Validation Accuracy by Class:
              Target |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
              ------ | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   760    13     0     2   99.74%    0.00%   98.32%    0.00%   99.02%   98.06%
                   0 |     0     2   760    13    0.00%   99.74%    0.00%   98.32%    0.00%    0.00%
...
n_classes = 2
model_cap = 13
logits_dict = {0: np.array([0.0, 0.0, -0.00400000019, 0.0, 0.0, 0.0120000001, -0.00999999978, 0.0194425862, 0.00285714283]), 1: np.array([0.0, 0.0, 0.00400000019, 0.0, 0.0, -0.0120000001, 0.00999999978, -0.0194425862, -0.00285714283]), 2: np.array([0.0, 0.0, -0.00395203847, 0.00281168451, 0.0, 0.0190614108, 0.00281634345]), 3: np.array([0.0, 0.0, 0.00395203708, -0.00281168614, 0.0, -0.0190614108, -0.00281634205]), 4: np.array([0.0, 0.0, -0.00390472705, 0.00277157221, 0.0, 0.0187014136, 0.00277615781]), 5: np.array([0.0, 0.0, 0.00390472589, -0.00277157151, 0.0, -0.0187014118, -0.00277615781]), 6: np.array([0.0, 0.0, -0.00385805103, 0.00273206038, 0.0, 0.0183608867, 0.00273657613]), 7: np.array([0.0, 0.0, 0.00385805103, -0.00273206038, 0.0, -0.0183608867, -0.00273657613]), 8: np.array([0.0, 0.0, -0.00381200295, 0.00269314065, 0.0, 0.0180383101, 0.00269758725]), 9: np.array([0.0, 0.0, 0.00381200342, -0.00269314065, 0.0, -0.0180383101, -0.00269758841])}
right_children_dict = {0: np.array([1, 3, -1, 5, 7, -1, -1, -1, -1]), 1: np.array([1, 3, -1, 5, 7, -1, -1, -1, -1]), 2: np.array([1, 3, -1, -1, 5, -1, -1]), 3: np.array([1, 3, -1, -1, 5, -1, -1]), 4: np.array([1, 3, -1, -1, 5, -1, -1]), 5: np.array([1, 3, -1, -1, 5, -1, -1]), 6: np.array([1, 3, -1, -1, 5, -1, -1]), 7: np.array([1, 3, -1, -1, 5, -1, -1]), 8: np.array([1, 3, -1, -1, 5, -1, -1]), 9: np.array([1, 3, -1, -1, 5, -1, -1])}
split_feats_dict = {0: np.array([76, 100, 0, 1, 131, 0, 0, 0, 0]), 1: np.array([76, 100, 0, 1, 131, 0, 0, 0, 0]), 2: np.array([76, 100, 0, 0, 131, 0, 0]), 3: np.array([76, 100, 0, 0, 131, 0, 0]), 4: np.array([76, 100, 0, 0, 131, 0, 0]), 5: np.array([76, 100, 0, 0, 131, 0, 0]), 6: np.array([76, 100, 0, 0, 131, 0, 0]), 7: np.array([76, 100, 0, 0, 131, 0, 0]), 8: np.array([76, 100, 0, 0, 131, 0, 0]), 9: np.array([76, 100, 0, 0, 131, 0, 0])}
split_vals_dict = {0: np.array([2.99655008, -2.5374999, 0.0, -0.00642500073, 2.70770001, 0.0, 0.0, 0.0, 0.0]), 1: np.array([2.99655008, -2.5374999, 0.0, -0.00642500073, 2.70770001, 0.0, 0.0, 0.0, 0.0]), 2: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 3: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 4: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 5: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 6: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 7: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 8: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0]), 9: np.array([2.99655008, -2.5374999, 0.0, 0.0, 2.70770001, 0.0, 0.0])}
...
def __classify(rows, return_probabilities=False, force_serial=False):
    ...
    logits = [__build_logit_func(10, clss) for clss in range(n_classes)]

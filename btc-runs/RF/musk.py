...
# Invocation: brainome TRAIN_TEST_SPLITS/musk-clean-train.csv -f RF -y -split 70 -modelonly -q -o btc-runs/RF/musk.py -json btc-runs/RF/musk.json
# Total compiler execution time: 0:00:07.61. Finished on: Feb-26-2022 18:35:07.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/RF/musk.py
    ...
    Generalization Ratio:       1001.87 bits/bit
    Percent of Data Memorized:     0.24%
    Resilience to Noise:          -3.21 dB
...
n_classes = 2
model_cap = 2
logits_dict = {0: np.array([0.0, -0.944008768, 0.947107136]), 1: np.array([0.0, 0.944008768, -0.947107136])}
right_children_dict = {0: np.array([1, -1, -1]), 1: np.array([1, -1, -1])}
split_feats_dict = {0: np.array([0, 0, 0]), 1: np.array([0, 0, 0])}
split_vals_dict = {0: np.array([1018.0, 0.0, 0.0]), 1: np.array([1018.0, 0.0, 0.0])}

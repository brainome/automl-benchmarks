...
# Invocation: brainome TRAIN_TEST_SPLITS/mc1-clean-train.csv -f RF -y -split 70 -modelonly -q -o btc-runs/RF/mc1.py -json btc-runs/RF/mc1.json
# Total compiler execution time: 0:00:06.53. Finished on: Feb-26-2022 18:32:53.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/RF/mc1.py
    Classifier Type:              Random Forest
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        99.28%
      Training accuracy:          99.54% (4616/4637 correct)
      Validation Accuracy:        99.29% (1975/1989 correct)
      Combined Model Accuracy:    99.47% (6591/6626 correct)


    Model Capacity (MEC):         16    bits
    Generalization Ratio:         17.60 bits/bit
    Percent of Data Memorized:    24.46%
    Resilience to Noise:          -2.45 dB
    ...
    Training Accuracy by Class:
                   ...
                   - | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  4604    21    12     0  100.00%   36.36%   99.55%  100.00%   99.77%   99.55%
                   1 |    12     0  4604    21   36.36%  100.00%  100.00%   99.55%   53.33%   36.36%

    Validation Accuracy by Class:
                   c |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
                   - | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1972    12     3     2   99.90%   20.00%   99.40%   60.00%   99.65%   99.30%
                   1 |     3     2  1972    12   20.00%   99.90%   60.00%   99.40%   30.00%   17.65%


    Attribute Ranking:
                                      Feature | Relative Importance
                            ESSENTIAL_DENSITY :   0.2213
                        CYCLOMATIC_COMPLEXITY :   0.1212
                         LOC_CODE_AND_COMMENT :   0.0743
                                    LOC_BLANK :   0.0725
                          HALSTEAD_DIFFICULTY :   0.0608
                                   CALL_PAIRS :   0.0597
                           CYCLOMATIC_DENSITY :   0.0555
                              NUMBER_OF_LINES :   0.0536
                              PARAMETER_COUNT :   0.0267
                               LOC_EXECUTABLE :   0.0263
                            DESIGN_COMPLEXITY :   0.0241
                                 LOC_COMMENTS :   0.0214
                         NUM_UNIQUE_OPERATORS :   0.0209
                              CONDITION_COUNT :   0.0207
                                 BRANCH_COUNT :   0.0205
                          NUM_UNIQUE_OPERANDS :   0.0199
              NORMALIZED_CYLOMATIC_COMPLEXITY :   0.0194
                             PERCENT_COMMENTS :   0.0192
                               HALSTEAD_LEVEL :   0.0139
                                   NODE_COUNT :   0.0136
                              HALSTEAD_VOLUME :   0.0135
                              HALSTEAD_EFFORT :   0.0110
                             HALSTEAD_CONTENT :   0.0100
...
n_classes = 2
model_cap = 16
logits_dict = {0: np.array([0.0, 0.0, 0.0, 0.710469961, -0.0, 0.592117071, -0.38462308]), 1: np.array([0.0, 0.0, 0.0, -0.710469961, -0.0, -0.592117071, 0.38462308]), 2: np.array([0.0, 0.0, 0.0, 0.329502702, -0.277778596, 0.440497607, 0.0836985931]), 3: np.array([0.0, 0.0, 0.0, -0.329502702, 0.277778536, -0.440497607, -0.083698608]), 4: np.array([0.0, 0.0, 0.0, 0.228888497, 0.388474047, -0.0419664048, 0.286979944]), 5: np.array([0.0, 0.0, 0.0, -0.228888452, -0.388474047, 0.0419663601, -0.286979944]), 6: np.array([0.0, 0.0, 0.0, 0.373704225, 0.0965019986, 0.178819954, -0.735801935]), 7: np.array([0.0, 0.0, 0.0, -0.373704225, -0.0965019763, -0.178819954, 0.735801935]), 8: np.array([0.0, 0.0, 0.0, 0.35988757, 0.176482528, 0.307253927, -0.0908760428]), 9: np.array([0.0, 0.0, 0.0, -0.359887511, -0.176482409, -0.307253927, 0.0908760801]), 10: np.array([0.0, 0.0, 0.0, 0.358852386, 0.00912781432, 0.0687767118, -0.722312629]), 11: np.array([0.0, 0.0, 0.0, -0.358852386, -0.00912799034, -0.068776764, 0.722313285]), 12: np.array([0.0, 0.0, 0.0, 0.232985049, -0.440936208, 0.302650005, -0.315443426]), 13: np.array([0.0, 0.0, 0.0, -0.232985079, 0.440936327, -0.302650213, 0.315443218]), 14: np.array([0.0, 0.0, 0.0, 0.349215567, 0.106222145, 0.0264559593, -0.485192448]), 15: np.array([0.0, 0.0, 0.0, -0.349215597, -0.106222227, -0.0264562517, 0.485192448]), 16: np.array([0.0, 0.0, 0.0, 0.335108638, 0.0616533607, -0.0465003364, 0.331716299]), 17: np.array([0.0, 0.0, 0.0, -0.335107923, -0.0616533123, 0.0465003625, -0.331716269])}
right_children_dict = {0: np.array([1, 3, 5, -1, -1, -1, -1]), 1: np.array([1, 3, 5, -1, -1, -1, -1]), 2: np.array([1, 3, 5, -1, -1, -1, -1]), 3: np.array([1, 3, 5, -1, -1, -1, -1]), 4: np.array([1, 3, 5, -1, -1, -1, -1]), 5: np.array([1, 3, 5, -1, -1, -1, -1]), 6: np.array([1, 3, 5, -1, -1, -1, -1]), 7: np.array([1, 3, 5, -1, -1, -1, -1]), 8: np.array([1, 3, 5, -1, -1, -1, -1]), 9: np.array([1, 3, 5, -1, -1, -1, -1]), 10: np.array([1, 3, 5, -1, -1, -1, -1]), 11: np.array([1, 3, 5, -1, -1, -1, -1]), 12: np.array([1, 3, 5, -1, -1, -1, -1]), 13: np.array([1, 3, 5, -1, -1, -1, -1]), 14: np.array([1, 3, 5, -1, -1, -1, -1]), 15: np.array([1, 3, 5, -1, -1, -1, -1]), 16: np.array([1, 3, 5, -1, -1, -1, -1]), 17: np.array([1, 3, 5, -1, -1, -1, -1])}
split_feats_dict = {0: np.array([0, 1, 13, 0, 0, 0, 0]), 1: np.array([0, 1, 13, 0, 0, 0, 0]), 2: np.array([7, 6, 3, 0, 0, 0, 0]), 3: np.array([7, 6, 3, 0, 0, 0, 0]), 4: np.array([35, 7, 19, 0, 0, 0, 0]), 5: np.array([35, 7, 19, 0, 0, 0, 0]), 6: np.array([3, 18, 2, 0, 0, 0, 0]), 7: np.array([3, 18, 2, 0, 0, 0, 0]), 8: np.array([0, 36, 2, 0, 0, 0, 0]), 9: np.array([0, 36, 2, 0, 0, 0, 0]), 10: np.array([3, 18, 7, 0, 0, 0, 0]), 11: np.array([3, 18, 7, 0, 0, 0, 0]), 12: np.array([7, 2, 3, 0, 0, 0, 0]), 13: np.array([7, 2, 3, 0, 0, 0, 0]), 14: np.array([3, 18, 4, 0, 0, 0, 0]), 15: np.array([3, 18, 4, 0, 0, 0, 0]), 16: np.array([3, 18, 9, 0, 0, 0, 0]), 17: np.array([3, 18, 9, 0, 0, 0, 0])}
split_vals_dict = {0: np.array([12.5, 41.5, 0.5, 0.0, 0.0, 0.0, 0.0]), 1: np.array([12.5, 41.5, 0.5, 0.0, 0.0, 0.0, 0.0]), 2: np.array([0.0850000009, 2.5, 16.5, 0.0, 0.0, 0.0, 0.0]), 3: np.array([0.0850000009, 2.5, 16.5, 0.0, 0.0, 0.0, 0.0]), 4: np.array([50.5, 0.0549999997, 22.9899998, 0.0, 0.0, 0.0, 0.0]), 5: np.array([50.5, 0.0549999997, 22.9899998, 0.0, 0.0, 0.0, 0.0]), 6: np.array([0.5, 74.7949982, 17.5, 0.0, 0.0, 0.0, 0.0]), 7: np.array([0.5, 74.7949982, 17.5, 0.0, 0.0, 0.0, 0.0]), 8: np.array([5.5, 48.5299988, 1.5, 0.0, 0.0, 0.0, 0.0]), 9: np.array([5.5, 48.5299988, 1.5, 0.0, 0.0, 0.0, 0.0]), 10: np.array([0.5, 74.7949982, 0.409999996, 0.0, 0.0, 0.0, 0.0]), 11: np.array([0.5, 74.7949982, 0.409999996, 0.0, 0.0, 0.0, 0.0]), 12: np.array([0.0850000009, 2.5, 16.5, 0.0, 0.0, 0.0, 0.0]), 13: np.array([0.0850000009, 2.5, 16.5, 0.0, 0.0, 0.0, 0.0]), 14: np.array([0.5, 74.7949982, 86.5, 0.0, 0.0, 0.0, 0.0]), 15: np.array([0.5, 74.7949982, 86.5, 0.0, 0.0, 0.0, 0.0]), 16: np.array([0.5, 74.7949982, 12.5, 0.0, 0.0, 0.0, 0.0]), 17: np.array([0.5, 74.7949982, 12.5, 0.0, 0.0, 0.0, 0.0])}

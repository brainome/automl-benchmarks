...
# Invocation: brainome TRAIN_TEST_SPLITS/nursery-clean-train.csv -f RF -y -split 70 -modelonly -q -o btc-runs/RF/nursery.py -json btc-runs/RF/nursery.json
# Total compiler execution time: 0:00:06.32. Finished on: Feb-26-2022 18:36:08.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/RF/nursery.py
    ...
    Generalization Ratio:       2914.96 bits/bit
    Percent of Data Memorized:     0.07%
    Resilience to Noise:          -3.50 dB
...
n_classes = 2
model_cap = 2
logits_dict = {0: np.array([0.0, -0.998628199, 0.998156548]), 1: np.array([0.0, 0.998628199, -0.998156548])}
right_children_dict = {0: np.array([1, -1, -1]), 1: np.array([1, -1, -1])}
split_feats_dict = {0: np.array([7, 0, 0]), 1: np.array([7, 0, 0])}
split_vals_dict = {0: np.array([1989409540.0, 0.0, 0.0]), 1: np.array([1989409540.0, 0.0, 0.0])}

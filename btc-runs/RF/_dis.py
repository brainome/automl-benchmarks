...
# Invocation: brainome TRAIN_TEST_SPLITS/dis-clean-train.csv -f RF -y -split 70 -modelonly -q -o btc-runs/RF/_dis.py -json btc-runs/RF/_dis.json
# Total compiler execution time: 0:00:06.21. Finished on: Feb-26-2022 18:29:06.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/RF/_dis.py
    Classifier Type:              Random Forest
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        98.45%
      Training accuracy:          98.48% (1819/1847 correct)
      Validation Accuracy:        98.36% (780/793 correct)
      Combined Model Accuracy:    98.44% (2599/2640 correct)


    Model Capacity (MEC):          1    bits
    Generalization Ratio:        206.14 bits/bit
    Percent of Data Memorized:     1.83%
    Resilience to Noise:          -3.25 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1819    28     0     0  100.00%    0.00%   98.48%      N/A   99.24%   98.48%
                   1 |     0     0  1819    28    0.00%  100.00%      N/A   98.48%    0.00%    0.00%

    Validation Accuracy by Class:
               class |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   780    13     0     0  100.00%    0.00%   98.36%      N/A   99.17%   98.36%
                   1 |     0     0   780    13    0.00%  100.00%      N/A   98.36%    0.00%    0.00%
...
n_classes = 2
model_cap = 1
logits_dict = {0: np.array([0.0193726327]), 1: np.array([-0.0193726327])}
right_children_dict = {0: np.array([-1]), 1: np.array([-1])}
split_feats_dict = {0: np.array([0]), 1: np.array([0])}
split_vals_dict = {0: np.array([0.0]), 1: np.array([0.0])}

...
# Invocation: brainome TRAIN_TEST_SPLITS/delta_ailerons-clean-train.csv -f DT -y -split 70 -modelonly -q -o btc-runs/DT/delta_ailerons.py -json btc-runs/DT/delta_ailerons.json -rank
# Total compiler execution time: 0:00:06.13. Finished on: Feb-26-2022 18:58:44.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/DT/delta_ailerons.py
    Classifier Type:              Decision Tree
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        53.07%
      Training accuracy:          93.78% (3275/3492 correct)
      Validation Accuracy:        93.52% (1401/1498 correct)
      Combined Model Accuracy:    93.70% (4676/4990 correct)


    Model Capacity (MEC):         11    bits
    Generalization Ratio:        296.91 bits/bit
    Percent of Data Memorized:     0.67%
    Resilience to Noise:          -2.47 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1779   143  1496    74   96.01%   91.28%   92.56%   95.29%   94.25%   89.13%
                   1 |  1496    74  1779   143   91.28%   96.01%   95.29%   92.56%   93.24%   87.33%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   761    63   640    34   95.72%   91.04%   92.35%   94.96%   94.01%   88.69%
                   1 |   640    34   761    63   91.04%   95.72%   94.96%   92.35%   92.96%   86.84%
...
mapping = {'0': 0, '1': 1}
ignorelabels = []
ignorecolumns = ['PitchRate', 'currPitch', 'currRoll', 'diffRollRate']
target = ''
target_column = 5
important_idxs = [0]
ignore_idxs = [1, 2, 3, 4]
...
n_classes = 2
model_cap = 11
energy_thresholds = [-0.0015500000000000002, -0.00145, -0.00115, -0.0010500000000000002, -0.00095, -0.00075, -0.00025, 5e-05, 0.00015000000000000001, 0.00025, 0.00035]
start_label = 0

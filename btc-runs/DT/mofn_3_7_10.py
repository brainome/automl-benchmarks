...
# Invocation: brainome TRAIN_TEST_SPLITS/mofn-3-7-10-clean-train.csv -f DT -y -split 70 -modelonly -q -o btc-runs/DT/mofn_3_7_10.py -json btc-runs/DT/mofn_3_7_10.json -rank
# Total compiler execution time: 0:00:06.00. Finished on: Feb-26-2022 19:05:56.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/DT/mofn_3_7_10.py
    Classifier Type:              Decision Tree
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        77.97%
      Training accuracy:          78.05% (505/647 correct)
      Validation Accuracy:        77.77% (217/279 correct)
      Combined Model Accuracy:    77.96% (722/926 correct)


    Model Capacity (MEC):          1    bits
    Generalization Ratio:        383.40 bits/bit
    Percent of Data Memorized:     0.58%
    ...
    Training Accuracy by Class:
               ...
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   0 |  505  142    0    0  100.00%    0.00%   78.05%      N/A   87.67%   78.05%
                   1 |    0    0  505  142    0.00%  100.00%      N/A   78.05%    0.00%    0.00%

    Validation Accuracy by Class:
               class |   TP   FP   TN   FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   0 |  217   62    0    0  100.00%    0.00%   77.78%      N/A   87.50%   77.78%
                   1 |    0    0  217   62    0.00%  100.00%      N/A   77.78%    0.00%    0.00%
...
mapping = {'0': 0, '1': 1}
ignorelabels = []
ignorecolumns = ['Bit_1', 'Bit_2', 'Bit_3', 'Bit_4', 'Bit_5', 'Bit_6', 'Bit_7', 'Bit_8', 'Bit_9']
target = ''
target_column = 10
important_idxs = [0]
ignore_idxs = [1, 2, 3, 4, 5, 6, 7, 8, 9]
classifier_type = 'DT'
num_attr = 10
n_classes = 2
model_cap = 1
energy_thresholds = [1.7976931348623157e+308]
start_label = 0

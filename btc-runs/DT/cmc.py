...
# Invocation: brainome TRAIN_TEST_SPLITS/cmc-clean-train.csv -f DT -y -split 70 -modelonly -q -o btc-runs/DT/cmc.py -json btc-runs/DT/cmc.json -rank
# Total compiler execution time: 0:00:06.03. Finished on: Feb-26-2022 18:58:36.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/DT/cmc.py
    Classifier Type:              Decision Tree
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        57.32%
      Training accuracy:          68.37% (493/721 correct)
      Validation Accuracy:        66.77% (207/310 correct)
      Combined Model Accuracy:    67.89% (700/1031 correct)


    Model Capacity (MEC):          5    bits
    Generalization Ratio:         97.09 bits/bit
    Percent of Data Memorized:     2.07%
    Resilience to Noise:          -1.99 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   350   165   143    63   84.75%   46.43%   67.96%   69.42%   75.43%   60.55%
                   0 |   143    63   350   165   46.43%   84.75%   69.42%   67.96%   55.64%   38.54%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   145    70    62    33   81.46%   46.97%   67.44%   65.26%   73.79%   58.47%
                   0 |    62    33   145    70   46.97%   81.46%   65.26%   67.44%   54.63%   37.58%
...
mapping = {'1': 0, '0': 1}
ignorelabels = []
ignorecolumns = ['Wifes_age', 'Husbands_education', 'Wifes_religion', 'Husbands_occupation', 'Standard_of_living_index']
target = ''
target_column = 9
important_idxs = [1, 3, 5, 8]
ignore_idxs = [0, 2, 4, 6, 7]
classifier_type = 'DT'
num_attr = 9
n_classes = 2
model_cap = 5
energy_thresholds = [5.5, 11.5, 12.5, 13.5, 15.5]
start_label = 0

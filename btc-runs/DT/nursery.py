...
# Invocation: brainome TRAIN_TEST_SPLITS/nursery-clean-train.csv -f DT -y -split 70 -modelonly -q -o btc-runs/DT/nursery.py -json btc-runs/DT/nursery.json -rank
# Total compiler execution time: 0:00:06.35. Finished on: Feb-26-2022 19:07:23.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/DT/nursery.py
    ...
    Generalization Ratio:       5829.93 bits/bit
    Percent of Data Memorized:     0.04%
    Resilience to Noise:          -3.80 dB
...
mapping = {'1': 0, '0': 1}
ignorelabels = []
ignorecolumns = ['parents', 'has_nurs', 'form', 'children', 'housing', 'finance', 'social']
target = ''
target_column = 8
important_idxs = [7]
ignore_idxs = [0, 1, 2, 3, 4, 5, 6]
classifier_type = 'DT'
num_attr = 8
n_classes = 2
model_cap = 1
energy_thresholds = [1989409555.0]
start_label = 0

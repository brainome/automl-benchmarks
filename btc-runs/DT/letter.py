...
# Invocation: brainome TRAIN_TEST_SPLITS/letter-clean-train.csv -f DT -y -split 70 -modelonly -q -o btc-runs/DT/letter.py -json btc-runs/DT/letter.json -rank
# Total compiler execution time: 0:00:07.37. Finished on: Feb-26-2022 19:00:35.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/DT/letter.py
    Classifier Type:              Decision Tree
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        95.94%
      Training accuracy:          96.84% (9490/9799 correct)
      Validation Accuracy:        97.11% (4080/4201 correct)
      Combined Model Accuracy:    96.92% (13570/14000 correct)


    Model Capacity (MEC):          1    bits
    Generalization Ratio:       2326.11 bits/bit
    Percent of Data Memorized:     0.14%
    Resilience to Noise:          -3.98 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   0 |   9397    305     93      4   99.96%   23.37%   96.86%   95.88%   98.38%   96.82%
                   1 |     93      4   9397    305   23.37%   99.96%   95.88%   96.86%   37.58%   23.13%

    Validation Accuracy by Class:
         binaryClass |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   0 |   4029    120     51      1   99.98%   29.82%   97.11%   98.08%   98.52%   97.08%
                   1 |     51      1   4029    120   29.82%   99.98%   98.08%   97.11%   45.74%   29.65%
...
mapping = {'0': 0, '1': 1}
ignorelabels = []
ignorecolumns = ['x_box', 'y_box', 'width', 'high', 'onpix', 'x_bar', 'y_bar', 'xybar', 'xy2br', 'x_ege', 'y_ege', 'yegvx']
target = ''
target_column = 16
important_idxs = [7, 8, 10, 13]
ignore_idxs = [0, 1, 2, 3, 4, 5, 6, 9, 11, 12, 14, 15]
classifier_type = 'DT'
num_attr = 16
n_classes = 2
model_cap = 1
energy_thresholds = [35.5]
start_label = 1

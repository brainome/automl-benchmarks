...
# Invocation: brainome TRAIN_TEST_SPLITS/mv-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/mv.py -json btc-runs/NN/mv.json
# Total compiler execution time: 0:01:07.33. Finished on: Feb-26-2022 18:52:33.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/mv.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        59.66%
      Training accuracy:          99.35% (19847/19975 correct)
      Validation Accuracy:        99.13% (8488/8562 correct)
      Combined Model Accuracy:    99.29% (28335/28537 correct)


    Model Capacity (MEC):         25    bits
    Generalization Ratio:        772.39 bits/bit
    Percent of Data Memorized:     0.26%
    Resilience to Noise:          -2.90 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |  11817     29   8030     99   99.17%   99.64%   99.76%   98.78%   99.46%   98.93%
                   0 |   8030     99  11817     29   99.64%   99.17%   98.78%   99.76%   99.21%   98.43%

    Validation Accuracy by Class:
         binaryClass |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |   5050     16   3438     58   98.86%   99.54%   99.68%   98.34%   99.27%   98.56%
                   0 |   3438     58   5050     16   99.54%   98.86%   98.34%   99.68%   98.94%   97.89%
...
column_mappings = [{1830392916.0: 0, 3499814433.0: 1, 4200685455.0: 2}, {1739204639.0: 0, 1978086825.0: 1}, {562391268.0: 0, 1500195262.0: 1}]
target = ''
target_column = 10
...
n_classes = 2
model_cap = 25
w_h = np.array([[-0.79888916015625, -0.022601865231990814, 0.07760629802942276, -0.03383800387382507, -0.32553330063819885, -0.8921472430229187, 0.03592187166213989, -24.47917366027832, -0.0338641032576561, 0.036604877561330795], [0.9492631554603577, -0.6498301029205322, 0.35686710476875305, -0.17108242213726044, -0.8977095484733582, 0.5285469889640808, 0.6311375498771667, 25.014652252197266, -0.17751383781433105, 0.22067275643348694]])
b_h = np.array([-1.119623064994812, 0.9053400158882141])
w_o = np.array([[1.7639198303222656, -0.33311381936073303]])
b_o = np.array(-0.7301006317138672)

...
# Invocation: brainome TRAIN_TEST_SPLITS/php50jXam-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/banknote_authentication.py -json btc-runs/NN/banknote_authentication.json
# Total compiler execution time: 0:00:25.96. Finished on: Feb-26-2022 18:38:36.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/banknote_authentication.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        55.52%
      Training accuracy:          98.95% (664/671 correct)
      Validation Accuracy:        98.96% (286/289 correct)
      Combined Model Accuracy:    98.95% (950/960 correct)


    Model Capacity (MEC):         13    bits
    Generalization Ratio:         50.61 bits/bit
    Percent of Data Memorized:     3.97%
    ...
    Training Accuracy by Class:
               ...
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   1 |  293    2  371    5   98.32%   99.46%   99.32%   98.67%   98.82%   97.67%
                   0 |  371    5  293    2   99.46%   98.32%   98.67%   99.32%   99.07%   98.15%

    Validation Accuracy by Class:
               Class |   TP   FP   TN   FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ---- ---- ---- ---- -------- -------- -------- -------- -------- --------
                   1 |  129    3  157    0  100.00%   98.12%   97.73%  100.00%   98.85%   97.73%
                   0 |  157    0  129    3   98.12%  100.00%  100.00%   97.73%   99.05%   98.12%
...
n_classes = 2
model_cap = 13
w_h = np.array([[0.2545691132545471, 0.2743854522705078, -0.560987651348114, -0.4738811254501343], [4.934596061706543, 2.627772569656372, 3.378272294998169, 0.4205569624900818]])
b_h = np.array([-14.00013256072998, -0.061597101390361786])
w_o = np.array([[0.13654935359954834, 1.7793352603912354]])
b_o = np.array(-7.9141621589660645)

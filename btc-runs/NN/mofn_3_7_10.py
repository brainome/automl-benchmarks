...
# Invocation: brainome TRAIN_TEST_SPLITS/mofn-3-7-10-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/mofn_3_7_10.py -json btc-runs/NN/mofn_3_7_10.json
# Total compiler execution time: 0:00:10.94. Finished on: Feb-26-2022 18:50:39.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/mofn_3_7_10.py
    ...
    Generalization Ratio:         44.65 bits/bit
    Percent of Data Memorized:     4.96%
...
n_classes = 2
model_cap = 11
w_h = np.array([[0.24885988235473633, 0.29974761605262756, -3.161982774734497, -3.4049336910247803, -3.413776159286499, -3.115821361541748, -3.295132637023926, -3.130509614944458, -3.5019302368164062, 0.20946939289569855]])
b_h = np.array([7.300379753112793])

...
# Invocation: brainome TRAIN_TEST_SPLITS/delta_ailerons-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/delta_ailerons.py -json btc-runs/NN/delta_ailerons.json
# Total compiler execution time: 0:00:51.17. Finished on: Feb-26-2022 18:40:01.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/delta_ailerons.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        53.07%
      Training accuracy:          93.84% (3277/3492 correct)
      Validation Accuracy:        94.39% (1414/1498 correct)
      Combined Model Accuracy:    94.00% (4691/4990 correct)


    Model Capacity (MEC):         78    bits
    Generalization Ratio:         41.90 bits/bit
    Percent of Data Memorized:     4.78%
    Resilience to Noise:          -1.62 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |  1774   136  1503    79   95.74%   91.70%   92.88%   95.01%   94.29%   89.19%
                   1 |  1503    79  1774   136   91.70%   95.74%   95.01%   92.88%   93.33%   87.49%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   0 |   763    52   651    32   95.97%   92.60%   93.62%   95.31%   94.78%   90.08%
                   1 |   651    32   763    52   92.60%   95.97%   95.31%   93.62%   93.94%   88.57%
...
n_classes = 2
model_cap = 78
w_h = np.array([[20.840240478515625, -3.941847562789917, -2.4743995666503906, 1.0550131797790527, 31.521095275878906], [-19.99920082092285, 4.479923725128174, 2.6913278102874756, -1.535287618637085, -31.023658752441406], [-0.18506696820259094, -0.12037122994661331, -0.585029125213623, -0.4055633246898651, -0.2524340748786926], [0.022684462368488312, 0.24209238588809967, 0.3674374222755432, -0.4151524603366852, -0.2666654586791992], [0.22242416441440582, 0.508506715297699, -0.12602636218070984, 0.45824551582336426, -0.0987042486667633], [0.06479763984680176, 0.5544887185096741, -0.5680797696113586, -0.38551169633865356, -0.15503142774105072], [-0.23870275914669037, 0.5290902853012085, -0.3969273567199707, -0.28189516067504883, -0.42782819271087646], [20.01919174194336, -4.706726551055908, -1.0700798034667969, 1.5421735048294067, 31.76723861694336], [0.032205622643232346, -0.3139532506465912, 0.1036040410399437, -0.5717689394950867, -0.44247967004776], [-19.583595275878906, 4.872299671173096, 2.09830641746521, -1.6593046188354492, -30.34583854675293], [0.39164936542510986, 0.6087797284126282, 0.24303971230983734, 0.08272714167833328, 0.4105873703956604]])
b_h = np.array([0.3031027317047119, 0.5041808485984802, -0.255113810300827, -0.9382155537605286, -0.5501969456672668, -0.1303756982088089, -0.6448031067848206, 0.4606655240058899, -0.5507636070251465, 1.2424159049987793, -0.33230534195899963])
w_o = np.array([[-11.033086776733398, 6.811659336090088, -0.5482237935066223, -0.4900858998298645, -0.3652797341346741, 0.3199467658996582, 0.2843703329563141, -7.187955856323242, 0.21362197399139404, 3.4953694343566895, -0.0892491564154625]])
b_o = np.array(-1.7180204391479492)

...
# Invocation: brainome TRAIN_TEST_SPLITS/cmc-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/cmc.py -json btc-runs/NN/cmc.json
# Total compiler execution time: 0:00:30.96. Finished on: Feb-26-2022 18:39:09.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/cmc.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        57.32%
      Training accuracy:          70.04% (505/721 correct)
      Validation Accuracy:        70.00% (217/310 correct)
      Combined Model Accuracy:    70.02% (722/1031 correct)


    Model Capacity (MEC):         23    bits
    Generalization Ratio:         21.61 bits/bit
    Percent of Data Memorized:     9.31%
    Resilience to Noise:          -1.34 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   371   174   134    42   89.83%   43.51%   68.07%   76.14%   77.45%   63.20%
                   0 |   134    42   371   174   43.51%   89.83%   76.14%   68.07%   55.37%   38.29%

    Validation Accuracy by Class:
         binaryClass |    TP    FP    TN    FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ----- ----- ----- ----- -------- -------- -------- -------- -------- --------
                   1 |   158    73    59    20   88.76%   44.70%   68.40%   74.68%   77.26%   62.95%
                   0 |    59    20   158    73   44.70%   88.76%   74.68%   68.40%   55.92%   38.82%
...
n_classes = 2
model_cap = 23
w_h = np.array([[0.15981850028038025, -0.21938252449035645, -0.03007638268172741, -1.1968300342559814, 0.6519113779067993, -0.19914531707763672, 0.06804480403661728, -0.5125391483306885, 1.1837050914764404], [-0.1869749277830124, -0.2878863513469696, 0.6381068825721741, -0.47871237993240356, -0.33997833728790283, -0.5159801840782166, -0.6916961073875427, -0.431120902299881, 0.6348552107810974]])
b_h = np.array([-0.1827380657196045, -0.08442546427249908])
w_o = np.array([[1.0202239751815796, 0.6854304671287537]])
b_o = np.array(-0.8321344256401062)

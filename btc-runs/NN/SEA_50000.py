...
# Invocation: brainome TRAIN_TEST_SPLITS/SEA_50000-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/SEA_50000.py -json btc-runs/NN/SEA_50000.json
# Total compiler execution time: 0:04:08.23. Finished on: Feb-26-2022 18:47:07.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/SEA_50000.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        61.43%
      Training accuracy:          84.14% (412321/489999 correct)
      Validation Accuracy:        84.26% (176948/210001 correct)
      Combined Model Accuracy:    84.18% (589269/700000 correct)


    Model Capacity (MEC):         11    bits
    Generalization Ratio:      36057.35 bits/bit
    Percent of Data Memorized:     0.01%
    Resilience to Noise:          -4.57 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ------- ------- ------- ------- -------- -------- -------- -------- -------- --------
                   1 |  143945   32646  268376   45032   76.17%   89.15%   81.51%   85.63%   78.75%   64.95%
                   0 |  268376   45032  143945   32646   89.15%   76.17%   85.63%   81.51%   87.36%   77.55%

    Validation Accuracy by Class:
               class |      TP      FP      TN      FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ------- ------- ------- ------- -------- -------- -------- -------- -------- --------
                   1 |   61918   13980  115030   19073   76.45%   89.16%   81.58%   85.78%   78.93%   65.20%
                   0 |  115030   19073   61918   13980   89.16%   76.45%   85.78%   81.58%   87.44%   77.68%
...
n_classes = 2
model_cap = 11
w_h = np.array([[0.6879509091377258, 0.6641331911087036, 0.0009086919017136097], [-0.9766637682914734, -0.5462915301322937, 0.001265468541532755]])
b_h = np.array([-2.974447011947632, 0.018166370689868927])
w_o = np.array([[0.7736599445343018, 0.9327499270439148]])
b_o = np.array(-2.1392822265625)

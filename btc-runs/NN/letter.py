...
# Invocation: brainome TRAIN_TEST_SPLITS/letter-clean-train.csv -f NN -y -split 70 -modelonly -q -o btc-runs/NN/letter.py -json btc-runs/NN/letter.json
# Total compiler execution time: 0:00:26.55. Finished on: Feb-26-2022 18:47:39.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        btc-runs/NN/letter.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  70% : 30%
    Accuracy:
      Best-guess accuracy:        95.94%
      Training accuracy:          97.55% (9559/9799 correct)
      Validation Accuracy:        97.95% (4115/4201 correct)
      Combined Model Accuracy:    97.67% (13674/14000 correct)


    Model Capacity (MEC):         37    bits
    Generalization Ratio:         63.32 bits/bit
    Percent of Data Memorized:     4.97%
    Resilience to Noise:          -2.41 dB
    ...
    Training Accuracy by Class:
         ...
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   0 |   9363    202    196     38   99.60%   49.25%   97.89%   83.76%   98.73%   97.50%
                   1 |    196     38   9363    202   49.25%   99.60%   83.76%   97.89%   62.03%   44.95%

    Validation Accuracy by Class:
         binaryClass |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
         ----------- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   0 |   4014     70    101     16   99.60%   59.06%   98.29%   86.32%   98.94%   97.90%
                   1 |    101     16   4014     70   59.06%   99.60%   86.32%   98.29%   70.14%   54.01%
...
n_classes = 2
model_cap = 37
w_h = np.array([[-0.1784786581993103, 0.11232314258813858, -0.6283814311027527, -0.6194161176681519, -0.37273696064949036, 0.07324666529893875, -0.10330911725759506, 0.2679564356803894, -0.20765475928783417, 0.11200852692127228, -0.38137176632881165, -0.19117482006549835, -0.7714318037033081, -0.5242757201194763, -0.011702971532940865, -0.09235750138759613], [-0.894798219203949, -0.3549211025238037, 1.2447352409362793, 1.4875835180282593, -1.3521445989608765, -0.05447925999760628, 0.8406545519828796, -0.5450533628463745, -1.4916044473648071, 0.6113895773887634, -1.2303284406661987, -0.4499985873699188, -0.26510095596313477, 0.06109343096613884, 1.395542860031128, 1.4380615949630737]])
b_h = np.array([-1.094140648841858, 5.516589164733887])
w_o = np.array([[-0.7226648330688477, -0.6863368153572083]])
b_o = np.array(2.164604902267456)
